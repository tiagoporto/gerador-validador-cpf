...
$(document).ready(function(){$("#cpf").mask("999.999.999-99")}),document.getElementById("btn-gerar-CPF").onclick=function(){for(var t="",n=null,e=null,r=null,a=0;9>a;++a)t+=Math.floor(9*Math.random())+"";for(var o=0;9>o;++o)n+=t.toString().charAt(o)*(10-o);var l=n%11;l=2>l?0:11-l,r=t+""+l;for(var i=0;10>i;++i)e+=r.toString().charAt(i)*(11-i);var c=e%11;c=2>c?0:11-c,t=t+"-"+l+c,document.getElementById("CPF").innerHTML=t},document.getElementById("valida-CPF").onsubmit=function(){for(var t=document.getElementById("cpf").value.substring(0,11).split(".").join(""),n=document.getElementById("cpf").value.substring(12,14),e=null,r=null,a=null,o=0;10>o;o++)if(""+t+n==""+o+o+o+o+o+o+o+o+o+o+o)return document.getElementById("resultadoValidacao").innerHTML="CEP inválido",!1;for(var o=0;9>o;++o)e+=t.toString().charAt(o)*(10-o);var l=e%11;l=2>l?0:11-l,a=t+""+l;for(var i=0;10>i;++i)r+=a.toString().charAt(i)*(11-i);var c=r%11;return c=2>c?0:11-c,document.getElementById("resultadoValidacao").innerHTML=n.toString()===l.toString()+c.toString()?"CEP válido":"CEP inválido",!1},function(t,n,e,r,a,o,l){t.GoogleAnalyticsObject=a,t[a]=t[a]||function(){(t[a].q=t[a].q||[]).push(arguments)},t[a].l=1*new Date,o=n.createElement(e),l=n.getElementsByTagName(e)[0],o.async=1,o.src=r,l.parentNode.insertBefore(o,l)}(window,document,"script","//www.google-analytics.com/analytics.js","ga"),ga("create","UA-32351360-4","auto"),ga("send","pageview");